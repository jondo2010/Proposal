...
\nomenclature{DAQ}{Data Acquisition device, provides and logs high-performance GPS, accelerometer, and ADC input data}
...
\paragraph{Difficulties in Bias Adjustment}
